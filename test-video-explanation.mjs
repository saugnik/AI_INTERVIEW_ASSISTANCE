/**
 * Test Video Explanation Service
 * Verifies the Gemini API fix for video explanation generation
 */

import { generateExplanationScript } from './services/videoExplanationService.js';
