...
const StudentAssignedQuestions: React.FC<StudentAssignedQuestionsProps> = ({ userEmail, onStartQuestion }) => {
    ...
    const autoGenerateAIQuestions = async () => {
        if (generatingAI || hasAutoGenerated) return;
        ...
        try {
            ...
            for (let i = 0; i < questionsToGenerate; i++) {
                await fetch(`${API_URL}/api/student/generate-ai-question`, {
                    method: 'POST',
                    headers: {
    ...
    useEffect(() => {
        if (activeTab === 'ai' && aiPractice.length === 0 && !generatingAI && !hasAutoGenerated) {
