            ...
            <div className="flex items-start justify-between gap-6">
                <div className="flex-1">
                    <div className="flex items-start gap-4">
                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg transition-transform group-hover:scale-110 ${
                            question.completed ? 'bg-emerald-500 text-white' : 
                ...
                <div className="border-b-2 border-slate-50 flex bg-slate-50/30">
                    {[
                        ...
                        <button
                            ...
                            className={`flex-1 flex items-center justify-center gap-3 px-8 py-6 font-black text-sm uppercase tracking-widest transition-all relative ${
                                activeTab === tab.id 
                        ...
                        <div className="mb-8">
                            {!showGenerator ? (
                                <button
                                    ...
                                    className="w-full group p-8 rounded-[32px] bg-gradient-to-br from-indigo-600 to-purple-700 text-white transition-all hover:shadow-2xl hover:shadow-indigo-500/40 relative overflow-hidden"
                                >
                                    <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full translate-x-1/3 -translate-y-1/3 blur-3xl group-hover:scale-110 transition-transform"></div>
                                    <div className="relative z-10 flex flex-col items-center">
                                        <div className="w-20 h-20 rounded-3xl bg-white/20 backdrop-blur-md flex items-center justify-center mb-6 group-hover:rotate-12 transition-transform">
                                            <ZapIcon className="w-10 h-10 text-yellow-300 fill-yellow-300" />
                                        </div>
                                        <h3 className="text-3xl font-black mb-2 font-heading">Summon AI Challenge</h3>
                                        <p className="text-indigo-100 font-medium">Generate a personalized interview problem based on your level</p>
                                    </div>
                                </button>
                            ) : (
